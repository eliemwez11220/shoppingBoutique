            ...
            if (!empty($produits)) { ?>
                ...
                <div class="col-md-5 col-md-push-2">
                    <div id="product-main-img">
                        <div class="product-preview">
                            <img src="<?= base_url('assets/uploads/images/products/') . $produits['product_image']; ?>"
                                 alt="Article Shopiza" height="300">
                        </div>
                        <div class="product-preview">
                            <img src="<?= base_url('assets/uploads/images/products/') . $produits['image_deux']; ?>"
                                 alt="Article Shopiza" height="300">
                        </div>

                        <div class="product-preview">
                            <img src="<?= base_url('assets/uploads/images/products/') . $produits['image_trois']; ?>"
                                 alt="Article Shopiza" height="300">
                        </div>
                ...
                <div class="col-md-2  col-md-pull-5">
                    <div id="product-imgs">
                        <div class="product-preview">
                            <img src="<?= base_url('assets/uploads/images/products/') . $produits['product_image']; ?>"
                                 alt="Article Shopiza" height="100">
                        </div>
                        <div class="product-preview">
                            <img src="<?= base_url('assets/uploads/images/products/') . $produits['image_deux']; ?>"
                                 alt="Article Shopiza" height="100">
                ...
                <div class="col-md-5">
                    <div class="product-details">
                        ...
                        <h2 class="product-name"><?= $produits['product_title']; ?></h2>
                        <small class="product-available">Disponible Stock</small>
                        <div>
                            <h3 class="product-price">$<?= $produits['product_price']; ?>
                                <del class="product-old-price">$<?= $produits['product_old_price']; ?></del>
                            </h3>
                        </div>
                        <div class="add-to-cart">
                            ...
                            <br>
                            <br>
                            <a href="<?= base_url('shopping/addToCart/') . $produits['product_id']; ?>"
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="section-title text-center">
                    <h3 class="title">Produits / Articles Similaires</h3>
                </div>
            </div>

            <?php $line = 1;
            if (!empty($produitsSimilaires)) {
                foreach ($produitsSimilaires as $value) { ?>
                                ...
                                <div class="product-img">
                                    ...
                                    <a href="<?= base_url('produits/details/') . $value->product_id; ?>">
                                        <img src="<?= base_url('assets/uploads/images/products/') . $value->product_image; ?>"
                                             alt="Article" height="300" width="360">
                                    </a>
